...
from model_robot import DCGAN
from a_utils import pp 
...
flags.DEFINE_string("checkpoint_dir", "checkpoint_robot", "Directory name to save the checkpoints [checkpoint]")
flags.DEFINE_string("summary_dir", "figure_robot", "Directory name to save the summaries [checkpoint]")
